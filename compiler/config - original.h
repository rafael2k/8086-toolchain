 ...
 */
#define	TRACE			/* Calls for trace/debugger support */
#define	EXTERNAL		/* Lists external definitions */
...
#define	TARGET_MASM_DEFAULT	/* Default Assembler is Microsoft Intel */
