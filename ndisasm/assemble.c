		     ...
		     insn *ins, const char *codes, long insn_end) 
{
	...
	case 0130: case 0131: case 0132:
		...
		// The following line was added fix a little-endian dependance. -WSF
		((char *)(&data))[0] = ins->oprs[c-0130].offset;
		// END
	...
	case 0140: case 0141: case 0142:
		...
		// The following line was added fix a little-endian dependance. -WSF
		// Don't know when this code is executed but it appears to have same bug as above (case 0130: case 0131: case 0132:)
		((char *)(&data))[0] = ins->oprs[c-0130].offset;
		// END
		out (offset, segment, &data, OUT_RAWDATA+1, NO_SEG, NO_SEG);
		offset++;
