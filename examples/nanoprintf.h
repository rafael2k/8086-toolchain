...
enum {
  ...
  NPF_FMT_SPEC_LEN_MOD_SHORT,
  NPF_FMT_SPEC_LEN_MOD_LONG_DOUBLE,
  NPF_FMT_SPEC_LEN_MOD_CHAR,
  NPF_FMT_SPEC_LEN_MOD_LONG,
#if NANOPRINTF_USE_LARGE_FORMAT_SPECIFIERS == 1
  NPF_FMT_SPEC_LEN_MOD_LARGE_LONG_LONG,
  NPF_FMT_SPEC_LEN_MOD_LARGE_INTMAX,
  NPF_FMT_SPEC_LEN_MOD_LARGE_SIZET,
  NPF_FMT_SPEC_LEN_MOD_LARGE_PTRDIFFT,
#endif
};
...
enum {
  ...
  NPF_FMT_SPEC_CONV_SIGNED_INT,
#if NANOPRINTF_USE_BINARY_FORMAT_SPECIFIERS == 1
  NPF_FMT_SPEC_CONV_BINARY,
#endif
  NPF_FMT_SPEC_CONV_OCTAL,
  NPF_FMT_SPEC_CONV_HEX_INT,
  NPF_FMT_SPEC_CONV_UNSIGNED_INT,
  NPF_FMT_SPEC_CONV_POINTER,
#if NANOPRINTF_USE_WRITEBACK_FORMAT_SPECIFIERS == 1
  NPF_FMT_SPEC_CONV_WRITEBACK,
#endif
#if NANOPRINTF_USE_FLOAT_FORMAT_SPECIFIERS == 1
  NPF_FMT_SPEC_CONV_FLOAT_DEC,
  NPF_FMT_SPEC_CONV_FLOAT_SCI,
  NPF_FMT_SPEC_CONV_FLOAT_SHORTEST,
  NPF_FMT_SPEC_CONV_FLOAT_HEX,
#endif
};
